...
@section('content')
<!-- Hero Section -->
<div class="relative bg-gradient-to-br from-green-50 via-white to-green-100 overflow-hidden min-h-[90vh] flex items-center pt-16 md:pt-0">
    <div class="absolute inset-0 z-0">
        <!-- Abstract decorative shapes -->
        <div class="absolute top-0 right-0 -mr-20 -mt-20 w-72 h-72 rounded-full bg-green-200 opacity-20 blur-3xl"></div>
        <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 rounded-full bg-emerald-300 opacity-20 blur-3xl"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div class="text-center lg:text-left order-2 lg:order-1 pb-16 lg:pb-0">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-100 text-green-700 font-semibold text-sm mb-6 animate-fade-in-up">
                ...
                <h1 class="text-4xl tracking-tight font-extrabold text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-4">
                    <span class="block">Segar Langsung</span>
                    <span class="block text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-400 pb-2">Dari Petani Lokal</span>
                </h1>
                <p class="mt-4 text-base text-slate-600 sm:text-lg sm:max-w-xl mx-auto lg:mx-0 md:mt-6 mb-8 lg:mb-10 leading-relaxed font-medium">
                    Belanja kebutuhan sayur, buah, dan bumbu dapur berkualitas premium dengan pengiriman cepat ke depan pintu rumah Anda tanpa repot.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="{{ route('products.index') }}" class="inline-flex items-center justify-center px-8 py-4 text-base font-bold rounded-full text-white bg-green-600 hover:bg-green-700 shadow-lg shadow-green-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-green-100">
                        Mulai Belanja
                    ...
                    <a href="#categories" class="inline-flex items-center justify-center px-8 py-4 text-base font-bold rounded-full text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 shadow-sm transition-all duration-300 transform hover:-translate-y-1">
                        Lihat Kategori
                    </a>
                </div>
                
                <!-- Trust indicators -->
                <div class="mt-10 sm:mt-12 flex items-center justify-center lg:justify-start gap-6 text-slate-500 text-sm font-semibold">
            ...
            <div class="order-1 lg:order-2 relative mt-8 lg:mt-0">
                <div class="relative w-full aspect-square max-w-md mx-auto lg:max-w-none lg:w-full lg:h-auto">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-tr from-green-300 to-emerald-100 rounded-full blur-2xl opacity-50 transform scale-90 translate-x-4 translate-y-4"></div>
                    <img class="relative w-full h-full object-cover rounded-[3rem] shadow-2xl z-10 border-8 border-white/50 transform hover:scale-[1.02] transition-transform duration-700" 
                         ...
                         alt="Sayuran segar">
                    <!-- Floating Badge -->
                    <div class="absolute -bottom-6 -left-6 z-20 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-bounce" style="animation-duration: 3s;">
...
<div id="categories" class="py-20 bg-white relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <a href="{{ route('categories.index') }}" class="hidden md:flex items-center text-green-600 font-semibold hover:text-green-700 transition">
                Lihat Semua Kategori <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            </a>
        </div>

        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 sm:gap-8">
            @forelse($categories as $category)
            <a href="{{ route('products.index', ['category' => $category->slug ?? $category->id]) }}" class="group block text-center">
                <div class="relative mx-auto w-24 h-24 sm:w-32 sm:h-32 rounded-full p-1 bg-white border border-slate-100 shadow-sm group-hover:shadow-md group-hover:border-green-200 transition-all duration-300">
                    <div class="w-full h-full rounded-full overflow-hidden bg-slate-50 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-300">
                        @if($category->image)
                ...
                <h4 class="mt-4 text-sm sm:text-base font-bold text-slate-800 group-hover:text-green-600 transition-colors">{{ $category->name }}</h4>
            </a>
            @empty
        ...
        <div class="mt-8 text-center md:hidden">
            <a href="{{ route('categories.index') }}" class="inline-flex items-center justify-center bg-slate-50 text-slate-700 hover:bg-slate-100 font-semibold py-3 px-6 rounded-full w-full transition border border-slate-200">
...
<div class="py-16 bg-slate-900 border-y border-slate-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <!-- Feature 1 -->
            <div class="flex flex-col items-center sm:flex-row sm:items-start text-center sm:text-left gap-6 group hover:-translate-y-1 transition-transform">
                <div class="w-16 h-16 shrink-0 bg-slate-800 ring-4 ring-slate-800 group-hover:ring-green-500/30 rounded-2xl flex items-center justify-center text-green-400 transition-all duration-300">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                </div>
                <div>
                    <h3 class="text-xl font-bold text-white mb-2">Kualitas Terjamin</h3>
                    <p class="text-slate-400 text-sm leading-relaxed">Produk disortir dengan ketat sebelum dikirim, memastikan hanya sayuran segar yang sampai ke tangan Anda.</p>
                </div>
            </div>
            <!-- Feature 2 -->
            <div class="flex flex-col items-center sm:flex-row sm:items-start text-center sm:text-left gap-6 group hover:-translate-y-1 transition-transform">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Pesan hari ini, sampai hari ini. Logistik kami menjamin kesegaran yang sama seperti saat baru dipanen.</p>
                </div>
            </div>
            <!-- Feature 3 -->
            <div class="flex flex-col items-center sm:flex-row sm:items-start text-center sm:text-left gap-6 group hover:-translate-y-1 transition-transform">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Sistem pembayaran yang aman dan jaminan garansi retur jika produk tidak sesuai standar kualitas.</p>
                </div>
            </div>
        </div>
    </div>
...
<div id="products" class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <a href="{{ route('products.index') }}" class="mt-4 md:mt-0 inline-flex items-center justify-center px-6 py-2.5 bg-white border border-slate-200 rounded-full text-slate-700 font-semibold hover:bg-slate-50 hover:text-green-600 transition shadow-sm w-fit">
